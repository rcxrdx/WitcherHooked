...
static_assert(sizeof(TObject) == 0xC, "TObject has incorrect size");
...
static_assert(sizeof(TString) == 0x10, "TString has incorrect size");
...
static_assert(sizeof(Udata) == 0x10, "Udata has incorrect size");
...
static_assert(sizeof(Proto) == 0x48, "Proto has incorrect size");
...
static_assert(sizeof(CClosure) == 0x1C, "CClosure has incorrect size");
...
static_assert(sizeof(LClosure) == 0x20, "LClosure has incorrect size");
...
static_assert(sizeof(Node) == 0x1C, "Node has incorrect size");
...
static_assert(sizeof(Table) == 0x20, "Table has incorrect size");
