...
void (*TW_Lua_Free)(void*) = (void (*)(void*))0x7EA350;
void* (*TW_Lua_Realloc)(void*, int32_t) = (void* (*)(void*, int32_t))0x7EA480;

#define l_realloc(b,os,s)	TW_Lua_Realloc(b,s)
#define l_free(b,os)		TW_Lua_Free(b)
