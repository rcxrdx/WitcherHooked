...
static_assert(sizeof(global_State) == 0xA0, "global_State has incorrect size");
...
static_assert(sizeof(lua_State) == 0x5C, "lua_State has incorrect size");
static_assert(offsetof(lua_State, top) == 8, "lua_State.top has incorrect offset");
